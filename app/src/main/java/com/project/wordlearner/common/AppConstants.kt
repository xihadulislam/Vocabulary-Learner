...
class AppConstants {
    ...
    companion object {
        ...
        const val privacy_policy_link =
            "https://firebasestorage.googleapis.com/v0/b/privacy-policy-b3dda.appspot.com/o/Encoder%20Decoder%2FEncoder%20Decoder.html?alt=media&token=779543a0-9431-4426-a646-50e0adc0ac3f"
        ...
        const val admob_test_native_ad_id = "ca-app-pub-3940256099942544/2247696110"
        ...
        const val E_TO_B = "E_TO_B"
        const val B_TO_E = "B_TO_E"
